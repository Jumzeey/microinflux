                ...
                <div className="relative z-10 text-white py-4 px-6 flex flex-col gap-10">
                    ...
                    <div className="flex gap-14">
                        <div className='flex flex-col'>
                            ...
                            <p className='font-medium text-2xl'>{overviewSummaryData.income}</p>
                        </div>
                        <div className='flex flex-col'>
                            <p className='font-thin text-sm'>Funds In Escrow</p>
                            <p className='font-medium text-2xl'>{overviewSummaryData.escrow}</p>
                        </div>
                        <div className='flex flex-col'>
                            <p className='font-thin text-sm'>Ave. Income Monthly</p>
                            <p className='font-medium text-2xl'>{overviewSummaryData.avgIncome}</p>
                        </div>
                    </div>
